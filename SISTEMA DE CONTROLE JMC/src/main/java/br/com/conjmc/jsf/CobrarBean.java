...
@ManagedBean(name = "cobrarBean")
@SessionScoped
@Configurable
@RooSerializable
@RooJsfManagedBean(entity = Cobrar.class, beanName = "cobrarBean")
public class CobrarBean implements Serializable {

	private static final long serialVersionUID = 1L;

	private String name = "Cobrars";

	private Cobrar cobrar;

	private List<Cobrar> allCobrars;
	...
	public List<Cobrar> getAllCobrars() {
        return allCobrars;
    }

	public void setAllCobrars(List<Cobrar> allCobrars) {
        this.allCobrars = allCobrars;
    }

	public String findAllCobrars() {
        allCobrars = Cobrar.findAllCobrars();
        dataVisible = !allCobrars.isEmpty();
        return null;
    }
	...
	public HtmlPanelGrid populateCreatePanel() {
        ...
        periodoCreateInput.setValueExpression("value", expressionFactory.createValueExpression(elContext, "#{cobrarBean.cobrar.periodo}", Date.class));
        ...
        motoqueiroCreateInput.setValueExpression("value", expressionFactory.createValueExpression(elContext, "#{cobrarBean.cobrar.motoqueiro}", Motoqueiros.class));
        motoqueiroCreateInput.setCompleteMethod(expressionFactory.createMethodExpression(elContext, "#{cobrarBean.completeMotoqueiro}", List.class, new Class[] { String.class }));
        ...
        numeroPedidoCreateInput.setValueExpression("value", expressionFactory.createValueExpression(elContext, "#{cobrarBean.cobrar.numeroPedido}", String.class));
        ...
        telefoneCreateInput.setValueExpression("value", expressionFactory.createValueExpression(elContext, "#{cobrarBean.cobrar.telefone}", String.class));
        ...
        valorCreateInput.setValueExpression("value", expressionFactory.createValueExpression(elContext, "#{cobrarBean.cobrar.valor}", Double.class));
        ...
        tipoPagamentoCreateInput.setValueExpression("value", expressionFactory.createValueExpression(elContext, "#{cobrarBean.cobrar.tipoPagamento}", String.class));
	...
	public HtmlPanelGrid populateEditPanel() {
        ...
        periodoEditInput.setValueExpression("value", expressionFactory.createValueExpression(elContext, "#{cobrarBean.cobrar.periodo}", Date.class));
        ...
        motoqueiroEditInput.setValueExpression("value", expressionFactory.createValueExpression(elContext, "#{cobrarBean.cobrar.motoqueiro}", Motoqueiros.class));
        motoqueiroEditInput.setCompleteMethod(expressionFactory.createMethodExpression(elContext, "#{cobrarBean.completeMotoqueiro}", List.class, new Class[] { String.class }));
        ...
        numeroPedidoEditInput.setValueExpression("value", expressionFactory.createValueExpression(elContext, "#{cobrarBean.cobrar.numeroPedido}", String.class));
        ...
        telefoneEditInput.setValueExpression("value", expressionFactory.createValueExpression(elContext, "#{cobrarBean.cobrar.telefone}", String.class));
        ...
        valorEditInput.setValueExpression("value", expressionFactory.createValueExpression(elContext, "#{cobrarBean.cobrar.valor}", Double.class));
        ...
        tipoPagamentoEditInput.setValueExpression("value", expressionFactory.createValueExpression(elContext, "#{cobrarBean.cobrar.tipoPagamento}", String.class));
	...
	public HtmlPanelGrid populateViewPanel() {
        ...
        periodoValue.setValueExpression("value", expressionFactory.createValueExpression(elContext, "#{cobrarBean.cobrar.periodo}", Calendar.class));
        ...
        motoqueiroValue.setValueExpression("value", expressionFactory.createValueExpression(elContext, "#{cobrarBean.cobrar.motoqueiro}", Motoqueiros.class));
        ...
        numeroPedidoValue.setValueExpression("value", expressionFactory.createValueExpression(elContext, "#{cobrarBean.cobrar.numeroPedido}", String.class));
        ...
        telefoneValue.setValueExpression("value", expressionFactory.createValueExpression(elContext, "#{cobrarBean.cobrar.telefone}", String.class));
        ...
        valorValue.setValueExpression("value", expressionFactory.createValueExpression(elContext, "#{cobrarBean.cobrar.valor}", String.class));
        ...
        tipoPagamentoValue.setValueExpression("value", expressionFactory.createValueExpression(elContext, "#{cobrarBean.cobrar.tipoPagamento}", String.class));
        htmlPanelGrid.getChildren().add(tipoPagamentoValue);
        
        return htmlPanelGrid;
    }

	public Cobrar getCobrar() {
        if (cobrar == null) {
            cobrar = new Cobrar();
        }
        return cobrar;
	...
	public void setCobrar(Cobrar cobrar) {
        this.cobrar = cobrar;
    }
	...
	public String persist() {
        ...
        FacesMessage facesMessage = MessageFactory.getMessage(message, "Cobrar");
        FacesContext.getCurrentInstance().addMessage(null, facesMessage);
        reset();
        return findAllCobrars();
    }

	public String delete() {
        cobrar.remove();
        FacesMessage facesMessage = MessageFactory.getMessage("message_successfully_deleted", "Cobrar");
        FacesContext.getCurrentInstance().addMessage(null, facesMessage);
        reset();
        return findAllCobrars();
    }
